...
description: >-
  Suite of tools for creating elaborate, multi-component Codex.ai HTML artifacts
  using modern frontend web technologies (React, Tailwind CSS, shadcn/ui). Use ONLY
  for self-contained HTML artifact bundles.
  
  TRIGGER when: "build an HTML artifact", "create a web artifact", "Codex.ai artifact",
