...
description: >-
  Use when auditing Codex skills and commands for quality. Supports Quick Scan
...
- Evaluation is blind: the same checklist applies to all skills regardless of origin (community, self-authored, auto-extracted)
